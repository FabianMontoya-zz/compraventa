<%@ Page Title="Ventas" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="Ventas.aspx.cs" Inherits="compraventa.VentasCredito.VentasCredito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="TransaccionesAjaxVentas.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    <div id="Div_CardContend" class="demo-card-wide mdl-card mdl-shadow--2dp" style="padding-top: 64px;padding-bottom: 60px;">
        <div class="mdl-card__title" id="Title_Card">
            <h2 class="mdl-card__title-text">VENTAS PRODUCTOS</h2>
        </div>
