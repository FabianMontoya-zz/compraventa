function TransaccionAjax_Personas(action) {
    ...
    $.ajax({
        type: "POST",
        url: "../VentasCredito/TransaccionAjaxVentasCredito.aspx",
        data: {
            "status": action
        },
        ...
        success: function (result) {
            ...
            switch (result) {
                case "Exito":
                    ...
                    window.location = "../Ventas/Ventas.aspx";
                    break;
                default:
